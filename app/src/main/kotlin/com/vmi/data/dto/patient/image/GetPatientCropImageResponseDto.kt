...
data class GetPatientCropImageResponseDto(
    var questionImageList: List<QuestionImageDto>,
    var answerImageList: List<AnswerImageDto>,
)


fun questionCropImageDtoAndAnswerImageDtoToGetPatientCropImageResponseDto(
    questionImageList: List<QuestionCropEntity>, answerImageList: AnswerCropEntity
) = GetPatientCropImageResponseDto(
    questionImageList.questionCropEntityListToQuestionImageDtoList(),
    answerImageList.answerCropEntityListToAnswerImageDtoList()
)

fun AnswerCropEntity.answerCropEntityListToAnswerImageDtoList(): List<AnswerImageDto> =
    listOf(
...
fun List<QuestionCropEntity>.questionCropEntityListToQuestionImageDtoList(): List<QuestionImageDto> =
