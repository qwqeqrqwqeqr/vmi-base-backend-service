...
class JWTAuthorizationFilter(
    ...
    private fun getAuthentication(token: String): UsernamePasswordAuthenticationToken? {
        return try {
            ...
            val userDetail = jwtUserDetailService.loadUserByUsername(claims.body.subject)
            return  UsernamePasswordAuthenticationToken(claims.body.subject, null, userDetail.authorities)
        } catch (e: Exception) {
            return null
        }
    }
